...
exports.topFive = exports.create = exports.show = exports.indexCategory = exports.index = void 0;
...
exports.index = index;
var indexCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.indexCategory(category)];
            case 2:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 4];
            case 3:
                err_2 = _a.sent();
                res.status(400).json(err_2 + category);
                return [3 /*break*/, 4];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_4 = _a.sent();
                res.status(400).json(err_4 + product);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var topFive = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opStore.topFive()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
