...
describe('Users Model', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = 'INSERT INTO users (id, password, firstName, lastName)'
                        + 'VALUES ($1, $2, $3, $4);';
                    return [4 /*yield*/, query_1.default(database_1.default, sql, ['test1', 'test123', 'Test', 'Test'])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, query_1.default(database_1.default, sql, ['test2', 'test123', 'Test', 'Test'])];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, query_1.default(database_1.default, sql, ['test3', 'test123', 'Test', 'Test'])];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('show', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.show('test1')];
                case 1:
                    user = _a.sent();
    ...
    it('delete', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.delete('test3')];
                case 1:
                    user = _a.sent();
